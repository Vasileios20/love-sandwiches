...
def calculate_sales_data(sales_row):
    ...
    - Negative suplus indicates extra made when stock sold out.
    """
    ...
    surplus_data = []
    for stock_num, sales_num in zip(stock_row,sales_row):
        surplus = stock_num - sales_num
...
def update_surplus_data(data):
    """
    updates surplus worksheet, add new row with the list provided.
    """
...
def main():
    ...
    new_surplus_data = calculate_sales_data(sales_data)
